...
<div class="container mt-3"<?php
  ...
  <form autocomplete="on" autofill="on" spellcheck="false"  action="index_Test.php"  method="POST" class="needs-validated"  enctype="multipart/form-data" id="ticketform" name="ticketform" data-ajax="false">
    <div class="mb-3 mt-3">
